...
//      console.log('score to add ->' + body);
      ...
      return this.http.post(`http://rdp-ghin-LB-1553122097.us-west-2.elb.amazonaws.com/score/addscore${params}`, body, {headers: headers})
  ...
  getScores() {
      ...
      const userid = localStorage.getItem('userId')
          ...
          : '';  
      const params = token + userid;
      return this.http.get(`http://rdp-ghin-LB-1553122097.us-west-2.elb.amazonaws.com/score/scores${params}`)
