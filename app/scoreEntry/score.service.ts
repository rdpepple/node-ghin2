...
//      console.log('score to add ->' + body);
      ...
      return this.http.post(`http://ghin-rdp.net:3000/score/addscore${params}`, body, {headers: headers})
  ...
  getScores() {
      ...
      const userid = localStorage.getItem('userId')
          ...
          : '';  
      const params = token + userid;
      return this.http.get(`http://ghin-rdp.net:3000/score/scores${params}`)
